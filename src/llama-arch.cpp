...
static const std::map<llm_kv, const char *> LLM_KV_NAMES = {
    ...
    { LLM_KV_YOCO_U_ITERS,                          "%s.yoco_u_iters"                          },
...
static const std::map<llm_tensor, const char *> LLM_TENSOR_NAMES = {
    ...
    { LLM_TENSOR_FFN_GATE_UP_EXPS_ACT_SCALE,            "blk.%d.ffn_gate_up_exps_act_scale" },
    { LLM_TENSOR_FFN_GATE_UP_EXPS_ACT_BIAS,             "blk.%d.ffn_gate_up_exps_act_bias" },
    { LLM_TENSOR_FFN_DOWN_EXPS_ACT_SCALE,               "blk.%d.ffn_down_exps_act_scale" },
    { LLM_TENSOR_FFN_DOWN_EXPS_ACT_BIAS,                "blk.%d.ffn_down_exps_act_bias" },
    { LLM_TENSOR_FFN_UP_EXPS,                            "blk.%d.ffn_up_exps" },
    { LLM_TENSOR_ATTN_POST_NORM,                         "blk.%d.post_attention_norm" },
    { LLM_TENSOR_ATTN_Q_NORM,                            "blk.%d.attn_q_norm" },
    { LLM_TENSOR_ATTN_K_NORM,                            "blk.%d.attn_k_norm" },
    { LLM_TENSOR_ATTN_Q_ACT_SCALE,                      "blk.%d.attn_q_act_scale" },
    { LLM_TENSOR_ATTN_Q_ACT_BIAS,                       "blk.%d.attn_q_act_bias" },
    { LLM_TENSOR_ATTN_K_ACT_SCALE,                      "blk.%d.attn_k_act_scale" },
    { LLM_TENSOR_ATTN_K_ACT_BIAS,                       "blk.%d.attn_k_act_bias" },
    { LLM_TENSOR_ATTN_V_ACT_SCALE,                      "blk.%d.attn_v_act_scale" },
    { LLM_TENSOR_ATTN_V_ACT_BIAS,                       "blk.%d.attn_v_act_bias" },
    { LLM_TENSOR_ATTN_OUT_ACT_SCALE,                    "blk.%d.attn_out_act_scale" },
    { LLM_TENSOR_ATTN_OUT_ACT_BIAS,                     "blk.%d.attn_out_act_bias" },
    { LLM_TENSOR_ATTN_GATE_ACT_SCALE,                   "blk.%d.attn_gate_act_scale" },
    { LLM_TENSOR_ATTN_GATE_ACT_BIAS,                    "blk.%d.attn_gate_act_bias" },
    ...
    { LLM_TENSOR_FFN_SHEXP_GATE_UP_ACT_SCALE,           "blk.%d.ffn_shexp_gate_up_act_scale" },
    { LLM_TENSOR_FFN_SHEXP_GATE_UP_ACT_BIAS,            "blk.%d.ffn_shexp_gate_up_act_bias" },
    { LLM_TENSOR_FFN_SHEXP_DOWN_ACT_SCALE,              "blk.%d.ffn_shexp_down_act_scale" },
    { LLM_TENSOR_FFN_SHEXP_DOWN_ACT_BIAS,               "blk.%d.ffn_shexp_down_act_bias" },
    ...
    { LLM_TENSOR_YOCO_CROSS_KV_NORM,                    "yoco_cross_kv_norm" },
    { LLM_TENSOR_YOCO_CROSS_K,                          "yoco_cross_k" },
    { LLM_TENSOR_YOCO_CROSS_V,                          "yoco_cross_v" },
    { LLM_TENSOR_YOCO_CROSS_K_NORM,                     "yoco_cross_k_norm" },
    { LLM_TENSOR_EMB_PROJ_IN,                           "emb_proj_in" },
    { LLM_TENSOR_EMB_PROJ_OUT,                          "emb_proj_out" },
    { LLM_TENSOR_EMB_IN_NORM,                           "emb_in_norm" },
    { LLM_TENSOR_EMB_OUT_NORM,                          "emb_out_norm" },
...
static const std::map<llm_tensor, llm_tensor_info> LLM_TENSOR_INFOS = {
    ...
    {LLM_TENSOR_YOCO_CROSS_KV_NORM,        {LLM_TENSOR_LAYER_OUTPUT,    GGML_OP_MUL}},
    {LLM_TENSOR_YOCO_CROSS_K,              {LLM_TENSOR_LAYER_OUTPUT,    GGML_OP_MUL_MAT}},
    {LLM_TENSOR_YOCO_CROSS_V,              {LLM_TENSOR_LAYER_OUTPUT,    GGML_OP_MUL_MAT}},
    {LLM_TENSOR_YOCO_CROSS_K_NORM,         {LLM_TENSOR_LAYER_OUTPUT,    GGML_OP_MUL}},
    {LLM_TENSOR_EMB_PROJ_IN,               {LLM_TENSOR_LAYER_INPUT,     GGML_OP_MUL_MAT}},
    {LLM_TENSOR_EMB_PROJ_OUT,              {LLM_TENSOR_LAYER_OUTPUT,    GGML_OP_MUL_MAT}},
    {LLM_TENSOR_EMB_IN_NORM,               {LLM_TENSOR_LAYER_INPUT,     GGML_OP_MUL}},
    {LLM_TENSOR_EMB_OUT_NORM,              {LLM_TENSOR_LAYER_OUTPUT,    GGML_OP_MUL}},
    ...
    {LLM_TENSOR_ATTN_Q_ACT_SCALE,           {LLM_TENSOR_LAYER_REPEATING, GGML_OP_MUL}},
    {LLM_TENSOR_ATTN_Q_ACT_BIAS,            {LLM_TENSOR_LAYER_REPEATING, GGML_OP_ADD}},
    {LLM_TENSOR_ATTN_K_ACT_SCALE,           {LLM_TENSOR_LAYER_REPEATING, GGML_OP_MUL}},
    {LLM_TENSOR_ATTN_K_ACT_BIAS,            {LLM_TENSOR_LAYER_REPEATING, GGML_OP_ADD}},
    {LLM_TENSOR_ATTN_V_ACT_SCALE,           {LLM_TENSOR_LAYER_REPEATING, GGML_OP_MUL}},
    {LLM_TENSOR_ATTN_V_ACT_BIAS,            {LLM_TENSOR_LAYER_REPEATING, GGML_OP_ADD}},
    {LLM_TENSOR_ATTN_OUT_ACT_SCALE,         {LLM_TENSOR_LAYER_REPEATING, GGML_OP_MUL}},
    {LLM_TENSOR_ATTN_OUT_ACT_BIAS,          {LLM_TENSOR_LAYER_REPEATING, GGML_OP_ADD}},
    {LLM_TENSOR_ATTN_GATE_ACT_SCALE,        {LLM_TENSOR_LAYER_REPEATING, GGML_OP_MUL}},
    {LLM_TENSOR_ATTN_GATE_ACT_BIAS,         {LLM_TENSOR_LAYER_REPEATING, GGML_OP_ADD}},

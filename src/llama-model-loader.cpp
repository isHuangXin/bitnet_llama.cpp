...
const char * llama_ftype_name(llama_ftype ftype) {
    ...
    switch ((enum llama_ftype) (ftype & ~LLAMA_FTYPE_GUESSED)) {
        ...
        case LLAMA_FTYPE_MOSTLY_I2_S:      name = LLAMA_FTYPE_PREFIX "I2_S"; break;
        ...
        case LLAMA_FTYPE_MOSTLY_TL1:       name = LLAMA_FTYPE_PREFIX "TL1"; break;
        case LLAMA_FTYPE_MOSTLY_TL2:       name = LLAMA_FTYPE_PREFIX "TL2"; break;
